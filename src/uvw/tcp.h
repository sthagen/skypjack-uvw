 ...
 * for further details.
 */
class UVW_EXTERN TCPHandle final: public StreamHandle<TCPHandle, uv_tcp_t, ConnectEvent, DataEvent, EndEvent, ListenEvent, WriteEvent, ShutdownEvent, CloseEvent, ErrorEvent> {
public:
