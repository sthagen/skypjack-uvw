 ...
 */
class UVW_EXTERN PipeHandle final: public StreamHandle<PipeHandle, uv_pipe_t, ConnectEvent, DataEvent, EndEvent, ListenEvent, WriteEvent, ShutdownEvent, CloseEvent, ErrorEvent> {
public:
